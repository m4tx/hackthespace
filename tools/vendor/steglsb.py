...
# Pillow >= 10.3 renamed ImageMath.eval to ImageMath.unsafe_eval and dropped the
# old name in Pillow 12. Keep the vendored code below working on both.
if not hasattr(ImageMath, "eval"):
    ImageMath.eval = ImageMath.unsafe_eval
