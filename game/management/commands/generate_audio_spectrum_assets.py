...
from game.puzzles.audio_spectrum.asset_generator import hide_text_in_audio
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        puzzle_root = os.path.join(app_root, 'puzzles', 'audio_spectrum')
        source_path = os.path.join(puzzle_root, 'audio', 'deadlyfox.ogg')
